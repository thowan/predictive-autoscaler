...
def main():
    ...
    steps_in, steps_out, n_features, ywindow = 130, 3, 1, 24
    ...
    while i <= len(series):
        ...
        if i % 144 == 0 or model is None:
            ...
            if model is None: 
                model = create_lstm(steps_in, steps_out,n_features, np.array(series), ywindow)
...
if __name__ == '__main__':
    ...
    # alpha = 0.7
    # main()
    alphas = np.linspace(0.1, 1,dtype = float, num=1)
