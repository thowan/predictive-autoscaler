...
def main():
    ...
    print("CPU above lstm: ", np.sum(above_list_lstm))
    print("CPU above hw: ", np.sum(above_list_hw))
    print("CPU above vpa: ", np.sum(above_list_vpa))
