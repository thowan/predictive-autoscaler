...
def main():
    ...
    steps_in, steps_out, n_features, ywindow = 96, 3, 1, params["window_future"]
    ...
    leg1 = ax1.legend(loc='lower center', bbox_to_anchor=(0.5, -0.30), fancybox=True, shadow=True, ncol=6, fontsize=22, labelspacing=0.1, handletextpad=0.3, columnspacing=0.4)
    leg1_lines = leg1.get_lines()
    plt.setp(leg1_lines, linewidth=5)

    ax1.set_xlabel('Observations', fontsize=25)
    ax1.set_ylabel('CPU (millicores)', fontsize=25)
    ...
    leg2 = ax2.legend(loc='lower center', bbox_to_anchor=(0.5, -0.30), fancybox=True, shadow=True, ncol=6, fontsize=22, labelspacing=0.1, handletextpad=0.3, columnspacing=0.4)
    leg2_lines = leg2.get_lines()
    plt.setp(leg2_lines, linewidth=5)

    ax2.set_xlabel('Observations', fontsize=25)
    ax2.set_ylabel('CPU (millicores)', fontsize=25)
    ...
    leg3 = ax3.legend(loc='lower center', bbox_to_anchor=(0.5, -0.30), fancybox=True, shadow=True, ncol=6, fontsize=22, labelspacing=0.1, handletextpad=0.3, columnspacing=0.4)
    leg3_lines = leg3.get_lines()
    plt.setp(leg3_lines, linewidth=5)

    ax3.set_xlabel('Observations', fontsize=25)
    ax3.set_ylabel('CPU (millicores)', fontsize=25)
    ...
    ax3.set_xlim(left=params["season_len"]*2)
...
if __name__ == '__main__':
    ...
    leg4 = ax4.legend(loc='lower center', bbox_to_anchor=(0.5, -0.30), fancybox=True, shadow=True, ncol=6, fontsize=22, labelspacing=0.1, handletextpad=0.3, columnspacing=0.4)
    leg4_lines = leg4.get_lines()
    plt.setp(leg4_lines, linewidth=5)
    
    ax4.set_xlabel('Alpha', fontsize=25)
    ax4.set_ylabel('CPU (millicores)', fontsize=25)
    ...
    leg5 = ax5.legend(loc='lower center', bbox_to_anchor=(0.5, -0.30), fancybox=True, shadow=True, ncol=6, fontsize=22, labelspacing=0.1, handletextpad=0.3, columnspacing=0.4)

    leg5_lines = leg5.get_lines()
    plt.setp(leg5_lines, linewidth=5)

    ax5.set_xlabel('Alpha', fontsize=25)
    ax5.set_ylabel('CPU (millicores)', fontsize=25)
